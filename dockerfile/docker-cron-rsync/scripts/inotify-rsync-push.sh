...
/usr/bin/inotifywait -mrq --format  '%Xe %w%f' -e modify,create,delete,attrib,close_write,move $local_dir | while read file         #把监控到有发生更改的"文件路径列表"循环
do
        ...
        then
                ...
                echo ${path#*/var/www/html/} >> /root/pre-push-file-list.ktsee
