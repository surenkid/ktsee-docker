...
/usr/bin/inotifywait -mrqd --format  '%Xe %w%f' -e modify,create,delete,attrib,close_write,move $local_dir/$upload_sub_folder | while read file         #把监控到有发生更改的"文件路径列表"循环
do
